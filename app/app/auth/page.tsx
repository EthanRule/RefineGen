          ...
          <div className="bg-stone-950 rounded-lg shadow-lg p-8 border border-stone-700">
            <div className="space-y-4">
              ...
              <button
                ...
                disabled={isLoading}
                className="w-full flex items-center justify-center px-4 py-3 bg-black text-white rounded-md shadow-sm hover:scale-101 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
              >
              ...
              <button
                ...
                disabled={isLoading}
                className="w-full flex items-center justify-center px-4 py-3 bg-white text-gray-700 border border-gray-300 rounded-md shadow-sm hover:scale-101 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
              >
              ...
              {error && (
                <div className="bg-stone-800 border border-stone-600 text-gray-300 px-4 py-3 rounded-md text-sm">
                  {error}
                </div>
              )}
